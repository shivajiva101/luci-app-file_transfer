...
define Package/luci-app-file_transfer/install
	$(INSTALL_DIR) $(1)/www/luci-static/resources/file_transfer/css
	$(INSTALL_DIR) $(1)/www/luci-static/resources/file_transfer/js
	...
	$(INSTALL_DATA) ./www/luci-static/resources/file_transfer/css/* $(1)/www/luci-static/resources/file_transfer/css
	$(INSTALL_DATA) ./www/luci-static/resources/file_transfer/js/* $(1)/www/luci-static/resources/file_transfer/js
endef
